...
function App() {
  ...
  <div>
    ...
    <div class="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <Link to="/posts"><p class="text-gray-800 transition-colors duration-200 transform dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6">Posts</p></Link>
      ...
      <div className="drawer-content flex flex-col">
        ...
        <div className="w-full navbar shadow">
          ...
          <div className="flex-1 px-2 mx-2 text-lg font-extrabold">Blog Project - Admin</div>
          <div className="flex-none hidden lg:block">
            <ul className="menu menu-horizontal">
              ...
              <button data-toggle-theme="business,light" data-act-class="ACTIVECLASS" className="btn">Toggle</button>
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 overflow-y-auto w-80 bg-base-100">
         {/* Sidebar */}
            ...
            <li><Link to="/comments">Comments</Link></li>
            <li><Link to="/login">Login</Link></li>
          <button className="btn" data-toggle-theme="business,light" data-act-class="ACTIVECLASS">Toggle</button>    
        </ul>
